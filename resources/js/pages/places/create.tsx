...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nuevo', href: '/places/create' },
];
...
export default function PlacesCreate() {
    ...
    const submit: FormEventHandler = async (e) => {
        ...
        try {
            await apiFormData(route('api.places.store'), formData, csrf_token);
        ...
        <DriverAppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto flex w-full max-w-lg flex-col gap-6 pb-8 lg:max-w-xl">
                <div className="flex items-start justify-between gap-3">
                    <HeadingSmall title="Agregar local" description="" />
                ...
                <form onSubmit={(e) => void submit(e)} className="space-y-5">
                    ...
                    <PlacePhotoPicker
                        label="Foto de fachada (opcional)"
                        photo={photo}
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                        <Button type="submit" disabled={processing} variant="sky" className="w-full sm:w-auto">
                            Enviar sugerencia
                        </Button>
